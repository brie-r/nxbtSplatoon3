...
const KEYMAP = {
	...
	69: "Y",				// Snap view
	// L & ZL
	221: "L",				// Lobby menu, I think
	50: "ZL",				// Squid form
	// R & ZR
	left mouse: "ZR",		// Main weapon
	right mouse: "R",		// Sub weapon
	// Add stealth swim analog modifier
	// 16: "LS_MOD"
}
...
function updatePosition(e) {
	...
	INPUT_PACKET["MOTION"]["GYRO_X"] = Math.round( e.movementX * -10 );
	INPUT_PACKET["MOTION"]["GYRO_Y"] = Math.round( e.movementY * 10 );
