...
class InputParser():
	...
	def parse_controller_input(self, controller_input):
		...
		motion_input = [
			controller_input["MOTION"]["ACCEL_X"],
			controller_input["MOTION"]["ACCEL_Y"],
			controller_input["MOTION"]["ACCEL_Z"],
			controller_input["MOTION"]["GYRO_X"],
			controller_input["MOTION"]["GYRO_Y"],
			controller_input["MOTION"]["GYRO_Z"]
		]
		self.protocol.set_motion_inputs(motion_input)
		self.protocol.set_imu_data()
